...
const assets = [
    ...
    [`${path.join(__dirname, './assets/css/media.css')}`, '/media', 'css'],
    [`${path.join(__dirname, './assets/css/fontawesome.css')}`, '/fontawesome', 'css'],
]
...
const others = [
    ...
    [`${path.join(__dirname, './assets/favicon.png')}`, `${outputDir_main}${outputDir_sub}`],
]
